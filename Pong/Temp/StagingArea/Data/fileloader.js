...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 4900323;
      var PACKAGE_UUID = '84a3d19f-f5c4-445b-b4dd-f4e73af2b693';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 20188, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(20188, 31532, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(31532, 41528, 0, 0).open('GET', '/level0');
    new DataRequest(41528, 41547, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(41547, 41850, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(41850, 2381150, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(2381150, 3910574, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(3910574, 4795026, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(4795026, 4872698, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(4872698, 4900323, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
