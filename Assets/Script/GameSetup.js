...
function Update () {
	...
	wall_top.offset = new Vector2 (0f, cam_main.ScreenToWorldPoint (new Vector3 (0f, 0f, 0f)).y - 0.5f);

	wall_bottom.size = new Vector2 (cam_main.ScreenToWorldPoint (new Vector3 (Screen.width * 2f, 0f, 0f)).x, 1f);
	wall_bottom.offset = new Vector2 (0f, cam_main.ScreenToWorldPoint (new Vector3 (0f, Screen.height, 0f)).y + 0.5f);
	...
	//player positions
	plyr_left.position.x = cam_main.ScreenToWorldPoint (new Vector3 (75f, 0f, 0f)).x;
	plyr_right.position.x = cam_main.ScreenToWorldPoint (new Vector3 (Screen.width - 75f, 0f, 0f)).x;
